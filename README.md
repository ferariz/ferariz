# Fernando Arizmendi
Physicist building production AI systems. Montevideo, Uruguay.
 
---
 
## Current Projects
 
- **[Skygent](https://github.com/ferariz/skygent)** — Hybrid agentic weather monitoring system. Deterministic threshold logic over ECMWF IFS forecasts, LLM narration, Telegram alerts. LangGraph · FastAPI.
- **AuditAI** — ISO 9001 certification assistant. Multi-stage conversation design, RAG over ISO corpus, document gap analysis. LangGraph · FAISS.
...
- 🌦️ **Former Director of R&D** — INUMET (Uruguay's national meteorology institute)
- 🎓 **Thesis Supervisor** — Universidad de Montevideo (Data Science MSc)
---
 
## Contact
 
📧 [arizmendi.f@gmail.com](mailto:arizmendi.f@gmail.com) &nbsp;·&nbsp; 💼 [LinkedIn](https://www.linkedin.com/in/fernando-arizmendi/) &nbsp;·&nbsp; ✍️ [Kaggle](https://www.kaggle.com/ferariz/)
